$(function () {
    $("#jqGrid").setjgGrid({api:'sys/common/uncont', hiddenFields:['DOCENTRY'], buttons: []});
    $("#jqGridList").setjgGridList({api:'sys/verHis/uncont', hiddenFields:['docEntry'], ischeck:true});
    $("#jqGriddiff").setjgGridList({api:'sys/verDiff/uncont', hiddenFields:['docEntry','isAdd'], ischeck:false,isred:true});
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            ...
            var url="budgbase/uncont/add";
            if(vm.info.docentry)
            {
                //修改
                url="budgbase/uncont/edit";
            }
        ...
        getInfo: function (id) {
            ...
            httpGetInfo("budgbase/uncont/view", {
                docEntry: id
            }, function (r) {
                if (r.code === 0) {
        ...
        selecteddeptcode: function (r,callback) {
            ...
            Document.initExpAcctList(vm.info.bplid, r,'','NCTR',function(result){
        ...
        postapprove: function (event) {
            var url="budgbase/uncont/postApprove";
        ...
        approve: function (event) {
            var url="budgbase/uncont/approve";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        reject: function (event) {
            var url="budgbase/uncont/reject";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        cancelclose: function (event) {
            var url="budgbase/uncont/cancelClose";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        copyfrom: function (event) {
            ...
            $.ajax({
                type: "POST",
                url: baseURL + "budgbase/uncont/copyFrom",
