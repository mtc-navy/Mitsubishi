...
import io.mtc.modules.sys.service.SysMenuService;
...
public class SysMenuController extends AbstractController {
	...
	public List<SysMenuEntity> list(){
		...
		Map<Long,SysMenuEntity> menuMap = menuList.stream().collect(Collectors.toMap(SysMenuEntity::getMenuId,sysMenuEntity -> sysMenuEntity));

		for(SysMenuEntity sysMenuEntity : menuList){
			SysMenuEntity parentMenuEntity = menuMap.get(sysMenuEntity.getParentId());
