    ...
    mounted: function () {
        ...
        $("#listTable").bind('paste', function (e) {
            ...
            if (pastedText != undefined) {
                ...
                _pasting = false;
                if (vm.isAddTotal) Document.calMonthTotal();
        ...
        layui.use('table', function () {
            ...
            vm.listTable = vm.BudTable.render({
                ...
                , cols: vm.isAddTotal ? BudsColsTotal : BudsCols
                , data: null
                , even: false
                , totalRow: true
                , id: 'Buds'
 ...
 */
var BudsCols = [[
    , {field: 'code', title: '产品代码',  style: 'background-color:#eee;font-size:12px', totalRowText: '合计', align: 'center',fixed:'left'}
    , {field: 'name', title: '产品名称',  style: 'background-color:#eee;font-size:12px', align: 'center',fixed:'left'}
    , {field: 'salesType', title: '销售类型',  style: 'background-color:#eee;font-size:12px', align: 'center',fixed:'left'}
...
var BudsColsTotal = [[
    ...
    , {field: 'month11', title: '11月', edit: 'text', style:'font-size:12px', totalRow: true, align: 'center'}
    , {field: 'month12', title: '12月', edit: 'text', style:'font-size:12px', totalRow: true, align: 'center'}
    , {field: 'total', title: '合计', edit: 'text',style:'font-size:12px', totalRow: true, align: 'center'}
