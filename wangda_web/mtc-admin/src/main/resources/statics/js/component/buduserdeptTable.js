 ...
 */
var BudsCols=[[
    ,{field: 'code', title: '项目代码',width:'8%',style:'background-color:#eee;',totalRowText:'合计',align:'center',hide:true,fixed:'left'}
    ,{field: 'name', title: '项目',width:'12.8%',style:'background-color:#eee',align:'center',fixed:'left'}
    ,{field: 'month01', title: '1月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month02', title: '2月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month03', title: '3月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month04', title: '4月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month05', title: '5月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month06', title: '6月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month07', title: '7月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month08', title: '8月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month09', title: '9月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month10', title: '10月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month11', title: '11月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
    ,{field: 'month12', title: '12月',edit: 'text',width:'6.6%',totalRow:true,align:'center'}
