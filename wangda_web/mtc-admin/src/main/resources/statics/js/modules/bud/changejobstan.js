$(function () {
    $("#jqGrid").setjgGrid({api:'sys/common/chancont', hiddenFields:['DOCENTRY'], buttons: [],height:$(window).height() - 165});
    $("#jqGridList").setjgGridList({api:'sys/verHis/chancont', hiddenFields:['docEntry'], ischeck:true});
    $("#jqGriddiff").setjgGridList({api:'sys/verDiff/chancont', hiddenFields:['docEntry','isAdd'], ischeck:false,isred:true});
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            ...
            var url="budgbase/chancont/add";
            if(vm.info.docentry)
            {
                //修改
                url="budgbase/chancont/edit";
            }
            httpPost(url,{
        ...
        getInfo: function (id) {
            ...
            httpGetInfo("budgbase/chancont/view", {
                docEntry: id
            }, function (r) {
                if (r.code === 0) {
                    vm.info=r.data.main;
        ...
        selecteddeptcode: function (r,callback) {
            ...
            Document.initExpAcctList(vm.info.bplid, r,'','CTRVAR',function(result){
        ...
        selectedpostcode: function (r) {
            ...
            Document.initExpAcctList(vm.info.bplid,vm.info.depcode, r,'CTRVAR',function(result){
                vm.drop.expAcctList = result;
                vm.initBuds();
            });
        },
        ...
        postapprove: function (event) {
            var url="budgbase/chancont/postApprove";
        ...
        approve: function (event) {
            var url="budgbase/chancont/approve";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        reject: function (event) {
            var url="budgbase/chancont/reject";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        close: function (event) {
            var url="budgbase/chancont/close";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        cancelclose: function (event) {
            var url="budgbase/chancont/cancelClose";
            httpPostFormData(url,{
                docEntry: vm.info.docentry
            },function(r){
                if (r.code === 0) {
        ...
        copyfrom: function (event) {
            ...
            $.ajax({
                type: "POST",
                url: baseURL + "budgbase/chancont/copyFrom",
