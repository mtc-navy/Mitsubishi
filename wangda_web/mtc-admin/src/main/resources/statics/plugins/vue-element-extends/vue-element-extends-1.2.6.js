...
// CONCATENATED MODULE: ./packages/table/src/table.vue?vue&type=template&id=6321249e&
...
// CONCATENATED MODULE: ./packages/editable/src/tool.js
            ...
            var UtilHandle = {
                browse: browse,
                getWheelName: function getWheelName() {
            ...
            var ScrollHandle = {
                ...
                scroll: function scroll() {
                    return function (evnt) {
                        ...
                        if (isRender) {
                            // 超过阈值重新渲染
                            var toVisibleStart = toVisibleIndex - Math.floor((renderSize - visibleSize) / 2);
            ...
            /* harmony default export */ var tablevue_type_script_lang_js_ = ({
                ...
                methods: {
                    ...
                    exportCsv: function exportCsv(options) {
                        ...
                        tool.downloadCsc(opts, tool.getCsvContent(opts, oData, columns, this.$el));
                    }
                    /******************************/
...
// CONCATENATED MODULE: ./packages/editable/src/event.js
            ...
            var wheelName = tool.getWheelName();
            var eventStore = [];
            var GlobalEvent = {
                ...
                methods: {
                    ...
                    _triggerKeydown: function _triggerKeydown(evnt) {
                        ...
                        if (ctxMenuStore.visible && [13, 32, 37, 38, 39, 40].includes(keyCode)) {
                            ...
                            if (_row2) {
                                ...
                                if (_column) {
                                    var _this$_getColumnByRow3 = this._getColumnByRowIndex(_row2.data, _column.property),
                                        _cell2 = _this$_getColumnByRow3.cell;

                                    this._triggerActive(_row2, _column, _cell2, event).then(function () {
                                        if (_this8.configs.checkedEditMethod ? _this8.configs.checkedEditMethod({
                                            ...
                                            external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(_row2.data, _column.property, null);
                                        }
                                    });
                                }
                            }
                    ...
                    _tabActiveCell: function _tabActiveCell(offsetRow, offsetColumn) {
                        if (this.configs.tabToActive) {
                            var _this$_getColumnByRow4 = this._getColumnByRowIndex(offsetRow.data, offsetColumn.property),
                            ...
                            if (_this11.configs.trigger !== 'manual' && tool.hasClass(cell, 'elx_edit') && (row.editActive ? _this11.configs.mode === 'row' && _this11.lastActive ? _this11.lastActive.column.property !== column.property : _this11.configs.mode === 'cell' && row.editActive !== column.property : true)) {
                                _this11._validActiveCell().then(function () {
                                    ...
                                    if (_this11.configs.trigger === type) {
                                        ...
                                        _this11._setChecked(row, column);
                                    }
                                }).catch(function (e) {
                                    return e;
                                }).then(function () {
                    ...
                    _setChecked: function _setChecked(row, column) {
                    ...
                    _toActiveRow: function _toActiveRow(record, prop) {
                        ...
                        var _this$_getColumnByRow5 = this._getColumnByRowIndex(record, prop),
                            row = _this$_getColumnByRow5.row,
                            column = _this$_getColumnByRow5.column,
                        ...
                        if (!disabled) {
                            ...
                            if (ctxMenuStore.info) {
                                ...
                                switch (code) {
                                    ...
                                    case 'CELL_REVERT':
                                        external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.set(row.data, column.property, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.get(row.store, column.property));
                                        break;
                                    ...
                                    case 'ROW_INSERT':
                                        this.insertAt(null, row.data).then(function (_ref15) {
                                            var _row = _ref15._row;
                                            return _this17._setChecked(_row, column);
                                        });
                                        break;
                     ...
                     * 还原整个表格数据
                     */
                    revert: function revert(records) {
                        this.currentRow = null;
                    ...
                    exportCsv: function exportCsv(options) {
                        ...
                        var columns = this.getColumns();
                        var oData = this.scrollLoad ? this._fullData : this._getData(this._getTDatas());
                        tool.downloadCsc(opts, tool.getCsvContent(opts, oData, columns, this.$el));
                    },
...
// CONCATENATED MODULE: ./packages/editable/src/editable.vue
            ...
            var editable_component = normalizeComponent(
                ...
                editablevue_type_template_id_4f0dc866_render,
                editablevue_type_template_id_4f0dc866_staticRenderFns,
                false,
                null,
                null,
                null
