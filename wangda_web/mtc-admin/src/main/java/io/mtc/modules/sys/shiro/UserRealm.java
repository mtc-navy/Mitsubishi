...
package io.mtc.modules.sys.shiro;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		info.setStringPermissions(ShiroUtils.getPermissions());
		return info;
	}
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		user = sysUserDao.getUserByUserName(token.getUsername().toUpperCase());
		...
		ShiroUtils.getSession().setAttribute(ShiroUtils.permission_key,permsSet);
