...
CREATE SEQUENCE sys_menu_seq start with 10000 ;
...
;
CREATE SEQUENCE MTC_SYS_DEPT_SEQ start with 10000 ;
...
CREATE TABLE sys_user (
  ...
  user_type varchar(10) COMMENT '用户类型:1-基地开票员，2-办事处开票员，3-客户',
...
CREATE SEQUENCE sys_role_seq start with 10000 ;

alter table SYS_ROLE add (SAP_ID NVARCHAR(20))
...
CREATE SEQUENCE sys_user_role_seq start with 100000 ;
...
CREATE SEQUENCE sys_role_dept_seq start with 1000 ;
...
CREATE SEQUENCE sys_config_seq start with 2000 ;
...
CREATE SEQUENCE sys_dict_seq start with 2000 ;
