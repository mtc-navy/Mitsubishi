	...
	<body>
            ...
            <div class="layui-container">
                <div class="layui-row">
                    <div class="text-middle layui-pull-left">
                        <span>
                            <i class="layui-icon layui-icon-release" style="font-size: 22px;"></i> 今日羊价
                        </span>
                    </div>
	    ...
	    <section style="margin: 80px 0px">
	        <div class="layui-container" style="margin-top: 20px;">
	            <blockquote class="layui-elem-quote">今日全国羊价<span style="color: #01AAED;font-size:15px;">&emsp;(仅供参考)</span></blockquote>
	            <table id="day_qg_price"></table><br>	        
	            <blockquote class="layui-elem-quote">今日省内羊价<span style="color: #01AAED;font-size:15px;">&emsp;(仅供参考)</span></blockquote>
